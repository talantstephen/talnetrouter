...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/talnetrouter/server.js.
...
function buildCliPackage() {
  console.log("📦 Building TalNet Router CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.talnetrouter/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.talnetrouter/runtime)");
  }
  console.log("");
